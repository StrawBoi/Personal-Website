    ...
    <section id="featured-project" className="relative py-24" data-testid="section-featured-project">
      <div className="container mx-auto px-6">
        ...
        <div className="relative mx-auto" style={{ maxWidth: 'min(1200px, calc(100vw - 8rem))' }}>
          <div className="pointer-events-none absolute inset-y-0 left-0 w-[1px] bg-amber-500/60" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-[1px] bg-amber-500/60" />
